...
$PartnerKey = $ini->variable( "WeatherModule", "PartnerID" );
$LicenseKey = $ini->variable( "WeatherModule", "LicenseKey" );
$Unit       = $ini->variable( "WeatherModule", "Unit" );
...
else
{
    if( $Local == "" )
    {   
        $Local = eZPreferences::value( "personalfrontpage_weather_widget" );
    }
    else
    {
        eZPreferences::setValue( "personalfrontpage_weather_widget", $Local );
    }
...
$Result['content'] =& $tpl->fetch( "design:widgets/weather.tpl" );
