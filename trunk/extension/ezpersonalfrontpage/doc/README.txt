...
Using the Weather.com module
============================

eZ Personal Frontpage includes an example weather widget using a data feed
by Weather.com. This data feed requires a Partner ID and a License Key,
which can be defined in the 'personalfrontpage.ini' located in

  /extension/ezpersonalfrontpage/settings

In order to receive those key you can register free of charge at

  http://www.weather.com/services/xmloap.html

If you obtained also the Weather.com SDK you can place the icons in:

  /extension/ezpersonalfrontpage/design/ezpersonalfrontpage/images/weathersdk

Remember to disable caching for personalfrontpage_weather_widget
as explained in the INSTALL file.
